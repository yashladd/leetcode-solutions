<h2><a href="https://leetcode.com/problems/implement-trie-ii-prefix-tree">1804. Implement Trie II (Prefix Tree)</a></h2><h3>Medium</h3><hr><p>A <a href="https://en.wikipedia.org/wiki/Trie" target="_blank"><strong>trie</strong></a> (pronounced as &quot;try&quot;) or <strong>prefix tree</strong> is a tree data structure used to efficiently store and retrieve keys in a dataset of strings. There are various applications of this data structure, such as autocomplete and spellchecker.</p>
